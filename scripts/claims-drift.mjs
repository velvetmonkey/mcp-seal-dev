...
// Claims drift guard. The claim / non-claim block is credibility-critical; this
// asserts the README mirror is a verbatim copy of the canonical block in
// docs/LIMITATIONS.md, so drift fails loudly instead of shipping silently.
//
...
// Per-line trim + drop blanks; strip any HTML wrapper. The claim text itself
// contains no HTML entities or tags, so tag-stripping is safe.
