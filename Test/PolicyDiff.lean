...
private def bundleCorpus : List (String × String) := [
  ...
  ("matcher unknown keys tolerated",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"always\",\"note\":\"x\"}}]}}"),
  ("target unknown keys tolerated",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"target\":[{\"literal\":\"x\",\"junk\":1}]}]}}"),
  -- tool rules
  ("mode alias guard/guarded",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"a\",\"mode\":\"guard\"},{\"name\":\"b\",\"mode\":\"guarded\"}]}}"),
  ("mode deny/allow",
  ...
  ("match equals",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"equals\",\"arg\":\"a.b\",\"value\":\"v\"}}]}}"),
  ("match starts_with",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"starts_with\",\"arg\":\"a\",\"value\":\"p\"}}]}}"),
  ("match contains_any_ci",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"contains_any_ci\",\"arg\":\"q\",\"needles\":[\"DROP\",\"delete\"]}}]}}"),
  ("match all nested any",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"all\",\"matches\":[{\"type\":\"always\"},{\"type\":\"any\",\"matches\":[{\"type\":\"equals\",\"arg\":\"x\",\"value\":\"1\"}]}]}}]}}"),
  ("match empty all/any accepted (signer is stricter)",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"all\",\"matches\":[]}}]}}"),
  ("match unsupported type",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"regex\",\"arg\":\"a\"}}]}}"),
  ("match type missing",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{}}]}}"),
  ("match needles non-string",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"contains_any_ci\",\"arg\":\"q\",\"needles\":[\"a\",7]}}]}}"),
  ("match empty arg path accepted (signer is stricter)",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"equals\",\"arg\":\"\",\"value\":\"v\"}}]}}"),
  ("match degenerate dotted path",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"match\":{\"type\":\"equals\",\"arg\":\"a..b.\",\"value\":\"v\"}}]}}"),
  -- targets: literal-first precedence + exactly-one rule
  ("target literal wins over arg",
  ...
  ("target not array",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"target\":{}}]}}"),
  ("target empty array accepted (guarded absent-target is signer-rejected)",
   "{\"epoch\":1,\"safety\":{\"approval\":{\"control_file\":\"c\"},\"tools\":[{\"name\":\"t\",\"mode\":\"guard\",\"target\":[]}]}}"),
  -- temporal (T)
  ("temporal roundtrip",
